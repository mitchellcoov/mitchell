...
export default function Home() {
    ...
    return (
        <>
            ...
            <div className="float-left flex flex-col place-items-center mr-8 ">
                <h3 className="text-5xl text-secondary mb-6 " >(he/him)</h3>
                <Image className="p-2 bg-auto bg-secondary rounded-md justify-self-center"
            ...
            <p className="paragraph mb-10">
                hopefully, my website has helped you learn more about me. thank you for visiting!
            </p>
        </>
    );
}
